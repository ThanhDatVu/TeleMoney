...
import Controller.ShowVayTienController;
 ...
 * @author hieun
 */
public class ShowVayTienView extends javax.swing.JFrame {

    /**
     * Creates new form ShowVayTien
     */
    ShowVayTienController showVayTienController;
    MasterTeleMoneyView master;
    UserModel acc;

    public ShowVayTienView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowVayTienView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowVayTienView().setVisible(true);
            }
        });
    }
