 ...
 * @author dat26
 */
public class ViewThem extends javax.swing.JFrame {
    ...
    public ViewThem(NhanvienView main) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewThem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
