...
import Controller.ShowGuiTienController;
 ...
 * @author hieun
 */
public class ShowGuiTienView extends javax.swing.JFrame {

    /**
     * Creates new form ShowGuiTien
     */
    ShowGuiTienController showGuiTienController;
    MasterTeleMoneyView master;
    UserModel acc;

    public ShowGuiTienView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowGuiTienView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowGuiTienView().setVisible(true);
            }
        });
    }
