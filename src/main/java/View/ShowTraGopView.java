...
import Controller.ShowTraGopController;
 ...
 * @author hieun
 */
public class ShowTraGopView extends javax.swing.JFrame {

    /**
     * Creates new form ShowTraGop
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowTraGopView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowTraGopView().setVisible(true);
            }
        });
    }
